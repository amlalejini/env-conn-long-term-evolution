...
default_environment_filename = "environment.cfg"

birth_method_modes = {
    "random-neighborhood": "0",
    "oldest/merit-neighborhood": "2",
    "well-mixed": "4"
}

slicing_method_modes = {
    "constant": "0",        # All receive equal
    "probabilistic": "1",   # Proportional to merit (probabilistic)
    "integrated": "2"       # Proportional to merit (deterministic)
}
...
combos.add_val(
    ...
    [
        "linear-chain",
        "barbell_clique10_chain90",
        "barbell_clique20_chain80",
        "barbell_clique50_chain50",
        "barbell_clique80_chain20",

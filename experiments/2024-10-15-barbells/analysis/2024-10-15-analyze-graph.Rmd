# 2024-10-15 - Analyze Graph Properties
...
```{r}
experiment_slug <- "2024-10-15-barbells"
...
```{r}
graph_name <- "node_info_barbell_clique20_chain80"
node_info_data_path <- paste(
  working_directory,
  "data",
  paste0(graph_name, ".csv"),
  sep = "/"
)
...
ggsave(
  filename = paste0(plot_dir, "/task_app_by_id_", graph_name, ".pdf"),
...
ggsave(
  filename = paste0(plot_dir, "/act_births_by_id_", graph_name, ".pdf"),
...
ggsave(
  filename = paste0(plot_dir, "/expected_births_by_id_", graph_name, ".pdf"),
...
ggsave(
  filename = paste0(plot_dir, "/all_task_prop_freq_dist_plt_", graph_name, ".pdf"),
...
ggsave(
  ...
  filename = paste0(plot_dir, "/all_task_prop_vs_expected_births_plt_", graph_name, ".pdf"),
...
ggsave(
  ...
  filename = paste0(plot_dir, "/all_task_prop_vs_actual_births_plt_", graph_name, ".pdf"),
...
ggsave(
  filename = paste0(plot_dir, "/node_properties_cor_", graph_name, ".pdf"),
  plot = plt,
  width = 20,
  height = 20
)
